...
const socialLinks = [
  ...
  {
    name: 'Twitter / X',
    handle: '@JoshiPrabin10',
    url: 'https://x.com/JoshiPrabin10',
    color: 'hover:bg-sky-700/30 hover:border-sky-500/30',
    icon: (
      <svg viewBox="0 0 24 24" className="w-6 h-6 fill-current">
  ...
  {
    name: 'YouTube',
    handle: '@prabinjoshi6040',
    url: 'http://www.youtube.com/@prabinjoshi6040',
    color: 'hover:bg-red-700/30 hover:border-red-500/30',
    icon: (
      <svg viewBox="0 0 24 24" className="w-6 h-6 fill-current">
